...
class Dispatch(commands.Cog):
    ...
    def choose(self, args, ch_name):
        ...
        resp = f"Fly the {pretty_aircraft} from {airport1.code} to {airport2.code} ({pretty_distance}nm)."
...
async def teardown(bot):
    del sys.modules['cogs.dispatch.vatsimatc']
    del sys.modules['cogs.dispatch.picker']
